    ...
    layui.use(["admin", "carousel"], function () {
        ...
        layui.use(["carousel", "echarts"], function () {
            ...
            if (n[0]) {
                ...
                }], m = e("#LAY-index-heapline").children("div"), s = function (e) {
                    r[e] = a.init(m[e], layui.echartsTheme), r[e].setOption(o[e]), window.onresize = r[e].resize
                };
                if (m[0]) {
                    s(0);
                    var y = [], d = [{
                        title: {text: "双数值轴折线", subtext: "纯属虚构"},
                        tooltip: {
                            trigger: "axis",
                        ...
                        }, {name: "数据2", type: "line", data: [[1, 2], [2, 3], [4, 2], [7, 5], [11, 2], [18, 3]]}]
                    }], c = e("#LAY-index-diffline").children("div"), p = function (e) {
                    ...
                    if (c[0]) {
                        ...
                        if (v[0]) {
                            ...
                            var h = [], f = [{
                                ...
                                yAxis: [{name: "流量(m^3/s)", type: "value", max: 500}, {
                                    name: "降雨量(mm)",
                                    type: "value",
                                    axisLabel: {
                                        formatter: function (e) {
                            ...
                            }], g = e("#LAY-index-area").children("div"), S = function (e) {
                                h[e] = a.init(g[e], layui.echartsTheme), h[e].setOption(f[e]), window.onresize = h[e].resize
                            };
                            if (g[0]) {
                                S(0);
                                var A = [], w = [{
                                    title: {text: "对数轴示例", x: "center"},
                                    tooltip: {trigger: "item", formatter: "{a} <br/>{b} : {c}"},
                                    legend: {x: "left", data: ["2的指数", "3的指数"]},
                                    xAxis: [{
                                        type: "category",
                                        name: "x",
                                        splitLine: {show: !1},
                                    ...
                                    }, {name: "2的指数", type: "line", data: [1, 2, 4, 8, 16, 32, 64, 128, 256]}]
                                }], k = e("#LAY-index-logline").children("div"), z = function (e) {
        ...
        var e = layui.$, a = (layui.carousel, layui.echarts), t = [], i = [{
            ...
            series: [{
                ...
                data: [{name: "西藏", value: 605.83}, {name: "青海", value: 1670.44}, {
                    name: "宁夏",
                    value: 2102.21
                }, {name: "海南", value: 2522.66}, {name: "甘肃", value: 5020.37}, {
                    name: "贵州",
                    value: 5701.84
                }, {name: "新疆", value: 6610.05}, {name: "云南", value: 8893.12}, {
                    name: "重庆",
                    value: 10011.37
                }, {name: "吉林", value: 10568.83}, {name: "山西", value: 11237.55}, {
                    name: "天津",
                    value: 11307.28
                }, {name: "江西", value: 11702.82}, {name: "广西", value: 11720.87}, {
                    name: "陕西",
                    value: 12512.3
                }, {name: "黑龙江", value: 12582}, {name: "内蒙古", value: 14359.88}, {
                    name: "安徽",
                    value: 15300.65
                }, {name: "北京", value: 16251.93, selected: !0}, {name: "福建", value: 17560.18}, {
                    name: "上海",
                    value: 19195.69,
                    selected: !0
                }, {name: "湖北", value: 19632.26}, {name: "湖南", value: 19669.56}, {
                    name: "四川",
                    value: 21026.68
                }, {name: "辽宁", value: 22226.7}, {name: "河北", value: 24515.76}, {
                    name: "河南",
                    value: 26931.03
                }, {name: "浙江", value: 32318.85}, {name: "山东", value: 45361.85}, {
                    name: "江苏",
                    value: 49110.27
                }, {name: "广东", value: 53210.28, selected: !0}]
            }]
        }], n = e("#LAY-index-plat").children("div"), l = function (e) {
            t[e] = a.init(n[e], layui.echartsTheme), t[e].setOption(i[e]), window.onresize = t[e].resize
        };
        n[0] && l(0)
    }), e("senior", {})
