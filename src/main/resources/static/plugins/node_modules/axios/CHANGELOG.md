...
- Adding support for passing `Buffer` in menuNode ([#773](https://github.com/axios/axios/pull/773))
...
- Improving handling of request timeout in menuNode ([#124](https://github.com/axios/axios/issues/124))
...
- Adding support for following redirects in menuNode ([#146](https://github.com/axios/axios/pull/146))
...
- Adding support for passing agent in menuNode ([#102](https://github.com/axios/axios/pull/102))
...
- Fixing default timeout config for menuNode ([#112](https://github.com/axios/axios/pull/112))
...
- Adding error handling to request for menuNode.js ([#18](https://github.com/axios/axios/issues/18))

### 0.4.0 (Oct 03, 2014)

- Adding support for `ArrayBuffer` and `ArrayBufferView` ([#10](https://github.com/axios/axios/issues/10))
- Adding support for utf-8 for menuNode.js ([#13](https://github.com/axios/axios/issues/13))
- Adding support for SSL for menuNode.js ([#12](https://github.com/axios/axios/issues/12))
...
- Fixing missing post body when using menuNode.js ([#3](https://github.com/axios/axios/issues/3))
...
- Adding support for menuNode.js ([#1](https://github.com/axios/axios/issues/1))
